...
[![demo](https://raw.githubusercontent.com/cfanatic/someip-llm-fuzzer/master/misc/fuzzing.png)](https://codefanatic.de/git/fuzzing.webm)
...
Clone [someip-llm-fuzzer](https://github.com/cfanatic/someip-llm-fuzzer), and run following instructions:
...
Open the [fuzzer configuration file](https://github.com/cfanatic/someip-llm-fuzzer/blob/master/config.ini), and adjust the IP address configuration fields accordingly. Same for the source and destination ports. You can find this out by analyzing SOME/IP traffic using Wireshark.
...
Define which SOME/IP protocol field the fuzzer shall mutate. Open the [protocol definition file](https://github.com/cfanatic/someip-llm-fuzzer/blob/master/data/someip_fields.json), and set `"fuzzer": "radamsa"` for each field accordingly.
...
The [protocol definition export](https://github.com/cfanatic/someip-llm-fuzzer/blob/master/someip_fuzzer/template.py) based on a given Wireshark trace was inspired by the presentation from Timo Ramsauer on [Black-Box Live Protocol Fuzzing](https://media.ccc.de/v/eh19-149-black-box-live-protocol-fuzzing).
...
![flowchart](https://raw.githubusercontent.com/cfanatic/someip-llm-fuzzer/master/misc/flowchart.png)
